...
| Active as of 2026-06-26 | *Computable Name*:Documentation |
...
```json
{
  ...
  "status" : "active",
  "date" : "2026-06-26T10:36:48+00:00",
  "publisher" : "ANS",
  "contact" : [{
    "name" : "ANS",
    "telecom" : [{
    ...
    "page" : {
      ...
      },
      {
        ...
        },
        {
          "extension" : [{
            "url" : "http://hl7.org/fhir/tools/StructureDefinition/ig-page-name",
            "valueUrl" : "mod_publier_ig_externe.html"
          }],
          "nameUrl" : "mod_publier_ig_externe.html",
          "title" : "Publier un IG externe",
          "generation" : "markdown"
        }]
      },
      {
