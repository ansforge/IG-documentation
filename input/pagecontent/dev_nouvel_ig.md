...
1/ Rajouter le [dossier .github](https://github.com/ansforge/IG-modele/tree/main/.github) au répertoire GitHub.
2/ Lancer l'action dans l'onglet `Actions`, qui va générer une branche gh-pages
